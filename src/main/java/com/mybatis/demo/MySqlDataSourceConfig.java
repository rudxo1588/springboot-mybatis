...
public class MySqlDataSourceConfig {
	...
	*/
	...
	DataSource mySqlDataSource , ApplicationContext applicationContext) throws Exception {
		...
		sqlSessionFactoryBean.setTypeAliasesPackage("com.mybatis.demo.biz.**.domain");	// xml파일에서 타입 지정시 해당 경로는 따로 작성하지 않아도 사용가능
		sqlSessionFactoryBean.setMapperLocations(applicationContext.getResources("classpath:mybatis/mysql/*.xml"));	// xml매퍼파일의 위치를 찾기위해 사용
